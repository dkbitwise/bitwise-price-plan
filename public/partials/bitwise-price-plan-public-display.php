...
<span class="tml-label">First Name <span>*</span></span>
<input tabindex="1" name="parent_f_name" id="parentfname" type="text" value="" class="tml-field">
...
<input tabindex="2" name="parent_l_name" type="text" id="parentlname" value="" class="tml-field">
<span class="parent_l_name-error error" style="display:none;">Please Enter Last Name</span>
</div>

<div class="tml-field-wrap tml-user_login-wrap">
<label class="tml-label" for="user_login">Username <span>*</span></label>
<input tabindex="3" name="user_login" type="text" value="" id="user_login" autocapitalize="off" class="tml-field">
...
<label class="tml-label" for="pass1">Password <span>*</span></label>
<input tabindex="4" name="user_pass1" type="password" value="" id="passw1" autocomplete="off" class="tml-field">
...
<label class="tml-label" for="pass2">Confirm Password <span>*</span></label>
<input tabindex="5" name="user_pass2" type="password" value="" id="passw2" autocomplete="off" class="tml-field">
...
<span class="tml-label">Email <span>*</span></span>
<input tabindex="6" name="parent_email" type="email" id="parentemail" value="" class="tml-field">
...
<span class="tml-label">Confirm Email <span>*</span></span>
<input tabindex="7" name="parent_cnf_email" type="email" id="parentcnfemail" value="" class="tml-field">
...
<label class="tml-label" for="parent_phone">Phone <span>*</span></label>
<div class="intl-tel-input">
<input tabindex="8" name="parent_phone" type="tel" value="" id="parent_phone" class="tml-field" autocomplete="off" placeholder="(201) 555-0123">
...
<div style="margin-top: 0px!important" class="tml-field-wrap tml-student_heading-wrap">Student Details <button data-id=1 style="float: right; color: #fff!important;background: #353866!important; border-color:#353866!important; padding: 0px 5px!important" name="add-stu" id="add-stu" class="btn btn-warning"> <i class="fa fa-user-plus" aria-hidden="true"></i></button></div>
</div>
...
<div class="panel panel-default">
	...
	<h4 style="background: #353866; padding: 3px 15px" class="panel-title">
	<a style="color: #fff!important" data-toggle="collapse" data-parent="#accordion" href="#stu1">Student 1</a>
	</h4>
	</div>
...
<div id="stud2" class="panel panel-default">

	<div class="panel-heading">
	<h4 style="background: #353866; padding: 3px 15px" class="panel-title">
	<a style="color: #fff!important" data-toggle="collapse" data-parent="#accordion" href="#stu2">Student 2</a>
	</h4>
	</div>
	
	<div id="stu2" class="panel-collapse collapse">
	<div class="panel-body">

		<div class="tml-field-wrap tml-first_name-wrap"><span class="tml-label">First Name <span>*</span></span>
		<input name="first_name[]" type="text" id="first_name2" value="" class="tml-field">
		<span class="first_name2-error error"  style="display:none;">Please Enter First Name</span> 
		</div>
		
		<div class="tml-field-wrap tml-last_name-wrap">
		<span class="tml-label">Last Name <span>*</span></span>
		<input name="last_name[]" type="text" value="" id="last_name2" class="tml-field">
		<span class="last_name2-error error" style="display:none;">Please Enter Last Name</span> 
		</div>
		
		<div class="tml-field-wrap tml-user_email-wrap">
		<label class="tml-label" for="user_email2">Email <span>*</span></label>
		<input name="user_email[]" type="email" value="" id="user_email2" class="tml-field">
		<span class="user_email2-error error" style="display:none;">Please Enter Email </span> 
		</div>
		
		<div class="tml-field-wrap tml-phone-wrap">
		<label class="tml-label" for="phone2">Phone <span>*</span></label>
		<div class="intl-tel-input">
		<input name="phone[]" type="tel" value="" id="phone2" data-id="2" class="tml-field" autocomplete="off" placeholder="(201) 555-0123">
		<span class="phone2-error error" style="display:none;">Please Enter Phone number</span>
		</div>
		</div>
